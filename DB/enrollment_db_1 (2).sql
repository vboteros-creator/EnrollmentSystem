...
INSERT INTO `enroll` VALUES (15,1001,2001,'');
...
INSERT INTO `students` VALUES (1001,'QW','W','QW','QW','QW');
...
INSERT INTO `subjects` VALUES (2001,'QW','QW1',1,'QW',NULL);
...
-- Dump completed on 2026-09-22  9:18:33
-- MySQL dump 10.13  Distrib 8.0.38, for Win64 (x86_64)
--
-- Host: localhost    Database: infomngt_login
-- ------------------------------------------------------
-- Server version	8.0.39
...
--
-- Table structure for table `user_school_year`
--

DROP TABLE IF EXISTS `user_school_year`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `user_school_year` (
  `userid` int NOT NULL,
  `school_year` varchar(100) NOT NULL,
  PRIMARY KEY (`userid`,`school_year`),
  CONSTRAINT `user_school_year_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `users` (`userid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `user_school_year`
--

LOCK TABLES `user_school_year` WRITE;
/*!40000 ALTER TABLE `user_school_year` DISABLE KEYS */;
INSERT INTO `user_school_year` VALUES (1,'1st_sy2025_2026'),(1,'2nd_sy2025_2026'),(1,'summer_sy2025_2026');
/*!40000 ALTER TABLE `user_school_year` ENABLE KEYS */;
UNLOCK TABLES;
